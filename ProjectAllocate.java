 ...
 */
public class ProjectAllocate extends javax.swing.JPanel {

    /**
     * Creates new form ProjectAllocate
     */
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(projmanCB, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(46, 46, 46)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public void allocateButtonMethod()
    {
               for(int k=0;k<emailList.length;k++){
                ...
                if (validation()) {
                    ...
                    Employee pl = (Employee) projmanCB.getSelectedItem();
                    ...
                    for (ProjEmp projEmpTemp : projEmpList) {
                        ...
                        if (projEmpTemp.getProjId().getProjId() == projEmp.getProjId().getProjId()) {
                            if (projEmpTemp.getEmpId().getDeptId().getDeptId() == projEmp.getEmpId().getDeptId().getDeptId()) {

                                flag = 2;
                            }
                            if (projEmpTemp.getEmpId().getEmpId() == projEmp.getEmpId().getEmpId()) {
                    ...
                    if (flag == 2) {
                        JOptionPane.showMessageDialog(WorkFlowEfficient.wfes, "Project Already Allocated in the Department");
                    }

                    if (flag == 3) {
                        JOptionPane.showMessageDialog(WorkFlowEfficient.wfes, "Project Already Allocated to this Project Manager");
                    }

                    if (flag == 0) {

                        new ProjEmpDal().addProjEmpDetails(projEmp);
                        ...
                        for (PlTl plTlTemp : plTlList) {
                            if (plTlTemp.getPlId().getEmpId() == projEmp.getEmpId().getEmpId()) {
                                ...
                                projEmp1.setEmpId(plTlTemp.getTlId());
    ...
    void fillComboDataProject(JComboBox jComboBox) {
        ...
        for (Project projectTemp : projectList) {
            if (projectTemp.getStatus() != 2 && projectTemp.getDeleteFlag() == 0) {
